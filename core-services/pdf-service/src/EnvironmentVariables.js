const envVariables = {
  ...
  EGOV_EXTERNAL_HOST: process.env.EGOV_EXTERNAL_HOST || "https://djibouti.tekdinext.com/" ,
  ...
  DEFAULT_LOCALISATION_LOCALE:
    ...
    process.env.DEFAULT_LOCALISATION_TENANT || "dj",
